...
charlies = Space.create(name: 'Charlies', address: '上海常熟路89', category: 'restaurant', sub_category: 'American', access: 'indoor and outdoor', features: ['dog_bowl', 'indoor', 'outdoor', 'dog food'], latitude: 121.447994,longitude: 31.216996 )
...
tacolicious = Space.create(name: 'Tacolicious', address: '上海余姚路34', category: 'restaurant', sub_category: 'Mexican', access: 'outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.443727,longitude: 31.236356)
...
westbund = Space.create(name: 'West Bund', address: '龙腾大道3268号', category: 'park', access: 'outdoor', features: ['outdoor'], latitude: 121.463961,longitude: 31.181555)
...
rooster = Space.create(name: 'The Rooster', address: '陕西北路455号', category: 'bar', access: 'indoor and outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.452868,longitude: 31.23035 )
...
abbeyroad = Space.create(name: 'Abbey Road', address: '桃江路3号', category: 'restaurant', sub_category: 'American', access: 'outdoor', features: ['dog_bowl', 'outdoor'], latitude: 121.451136,longitude: 31.20901 )
...
brewdog = Space.create(name: 'Brew Dog', address: '成都北路333号1楼', category: 'restaurant', sub_category: 'American', access: 'indoor and outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.46639,longitude: 31.227924 )
...
cottons = Space.create(name: 'Cottons', address: '新华路294号', category: 'restaurant', sub_category: 'American', access: 'outdoor', features: ['dog_bowl', 'outdoor'], latitude: 121.427003,longitude: 31.203237 )
...
cannery = Space.create(name: 'The Cannery', address: '愚园路1107号', category: 'restaurant', sub_category: 'American', access: 'indoor outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.428332,longitude: 31.218151 )
...
perch = Space.create(name: 'Perch', address: '江宁路445号', category: 'bar', access: 'indoor outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.452086,longitude: 31.234728 )
...
bbbagels = Space.create(name: 'Boom Boom Bagels', address: '安福路39号', category: 'restaurant', sub_category: 'American', access: 'indoor outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.44732,longitude: 31.214834 )
...
cocheese = Space.create(name: 'Co. Cheese Melt Bar', address: '南昌路509号', category: 'restaurant', sub_category: 'American', access: 'indoor outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.459687,longitude: 31.214943 )
...
mokabros = Space.create(name: 'Mokas Bros', address: '襄阳北路108号1楼', category: 'restaurant', sub_category: 'American', access: 'indoor outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.455933,longitude: 31.216204 )
...
cantinaagave = Space.create(name: 'Cantina Agave', address: '富民路291号', category: 'restaurant', sub_category: 'Mexican', access: 'outdoor', features: ['dog_bowl', 'outdoor'], latitude: 121.452766,longitude: 31.217343 )
...
omills = Space.create(name: 'OMills', address: '永嘉路110号', category: 'cafe', access: 'outdoor', features: ['dog_bowl','outdoor'], latitude: 121.460011,longitude: 31.209745 )
...
bruteatery = Space.create(name: 'Brut Eatery', address: '愚园路698号', category: 'cafe', access: 'outdoor', features: ['dog_bowl', 'outdoor'], latitude: 121.435844,longitude: 31.220971 )
...
bathe = Space.create(name: 'Bathe Coffee', address: '永康路70号', category: 'cafe', access: 'outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.458102,longitude: 31.210994 )
...
avc = Space.create(name: 'AVC', address: '斜土路1298号', category: 'vet', access: 'indoor', features: ['dog_bowl', 'indoor'], latitude: 121.463126,longitude: 31.197267 )
...
lewagon = Space.create(name: 'Le Wagon', address: '延平路425号2号楼401', category: 'other', access: 'indoor', features: ['dog_bowl', 'indoor', 'outdoor', 'dog_food'], latitude: 121.43737,longitude: 31.233334 )
...
paw = Space.create(name: 'Paw Clinic', address: '东青莲路99号', category: 'vet', access: 'indoor', features: ['dog_bowl', 'indoor'], latitude: 121.457754,longitude: 31.241917 )
...
dogcat = Space.create(name: 'Dog & Cat', address: '威海路379号', category: 'vet', access: 'indoor', features: ['dog_bowl', 'indoor'], latitude: 121.46439,longitude: 31.227084 )
...
beckstone = Space.create(name: 'Doctors Beck & Stone', address: '威宁路500号', category: 'vet', access: 'indoor', features: ['dog_bowl', 'indoor'], latitude: 121.386111,longitude: 31.217259 )
...
shenpu = Space.create(name: 'Shenpu Pet Hospital', address: '天山路185号', category: 'vet', access: 'indoor', features: ['dog_bowl', 'indoor'], latitude: 121.382698,longitude: 31.215397 )
shenpu.image.attach(io: URI.open('https://www.thatsmags.com/image/view/201811/shenpu.jpg'), filename: 'shenpu')

pudi = Space.create(name: 'Pudi Boutique Hotel', address: '雁荡路99号', category: 'other', access: 'indoor', features: ['dog_bowl', 'indoor'], latitude: 121.470061,longitude: 31.219298 )
...
fourpark = Space.create(name: 'Four Seasons Pet Park', address: '漕廊公路9133号', category: 'park', access: 'outdoor, indoor', features: ['outdoor'], latitude: 121.158609,longitude: 30.784756 )
...
zhujiajiao = Space.create(name: 'Zhujiajiao Water Village', address: '西湖街24号', category: 'park', access: 'outdoor, indoor', features: ['outdoor'], latitude: 121.053794,longitude: 31.107256 )
...
dongtan = Space.create(name: 'Dongtan Wetland Park', address: '东旺中路', category: 'park', access: 'outdoor', features: ['outdoor'], latitude: 121.910484,longitude: 31.513998 )
...
luneurs = Space.create(name: 'Luneurs', address: '番禺路381号', category: 'cafe', access: 'outdoor', features: ['dog_bowl', 'indoor', 'outdoor'], latitude: 121.43049,longitude: 31.204387 )
