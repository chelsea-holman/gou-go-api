...
fourpark = Space.create(name: 'Four Seasons Pet Park', address: '漕廊公路9133号', category: 'park', access: 'outdoor, indoor', features: '', latitude: 121.158609,longitude: 30.784756 )
...
zhujiajiao = Space.create(name: 'Zhujiajiao Water Village', address: '西湖街24号', category: 'park', access: 'outdoor, indoor', features: '', latitude: 121.053794,longitude: 31.107256 )
