...
rooster = Space.create(name: 'The Rooster', address: '陕西北路455号', category: 'bar', access: 'indoor and outdoor', features: 'dog bowl', longitude: 121.452868, latitude: 31.23035 )
...
abbeyroad = Space.create(name: 'Abbey Road', address: '桃江路3号', category: 'restaurant', access: 'outdoor', features: '', longitude: 121.451136, latitude: 31.20901 )
...
brewdog = Space.create(name: 'Brew Dog', address: '成都北路333号1楼', category: 'restaurant', access: 'indoor and outdoor', features: 'dog bowl', longitude: 121.46639, latitude: 31.227924 )
...
cottons = Space.create(name: 'Cottons', address: '新华路294号', category: 'restaurant', access: 'outdoor', features: 'dog bowl', longitude: 121.427003, latitude: 31.203237 )
...
cannery = Space.create(name: 'The Cannery', address: '愚园路1107号', category: 'restaurant', access: 'indoor outdoor', features: 'dog bowl', longitude: 121.428332, latitude: 31.218151 )
...
perch = Space.create(name: 'Perch', address: '江宁路445号', category: 'bar', access: 'indoor outdoor', features: 'dog bowl', longitude: 121.452086, latitude: 31.234728 )
...
bbbagels = Space.create(name: 'Boom Boom Bagels', address: '安福路39号', category: 'restaurant', access: 'indoor outdoor', features: '', longitude: 121.44732, latitude: 31.214834 )
...
cocheese = Space.create(name: 'Co. Cheese Melt Bar', address: '南昌路509号', category: 'restaurant', access: 'indoor outdoor', features: '', longitude: 121.459687, latitude: 31.214943 )
...
mokabros = Space.create(name: 'Mokas Bros', address: '襄阳北路108号1楼', category: 'restaurant', access: 'indoor outdoor', features: '', longitude: 121.455933, latitude: 31.216204 )
...
cantinaagave = Space.create(name: 'Cantina Agave', address: '富民路291号', category: 'restaurant', access: 'outdoor', features: '', longitude: 121.452766, latitude: 31.217343 )
...
omills = Space.create(name: 'OMills', address: '永嘉路110号', category: 'cafe', access: 'outdoor', features: '', longitude: 121.460011, latitude: 31.209745 )
...
bruteatery = Space.create(name: 'Brut Eatery', address: '愚园路698号', category: 'cafe', access: 'outdoor', features: '', longitude: 121.435844, latitude: 31.220971 )
...
bathe = Space.create(name: 'Bathe Coffee', address: '永康路70号', category: 'cafe', access: 'outdoor', features: '', longitude: 121.458102, latitude: 31.210994 )
...
avc = Space.create(name: 'AVC', address: '斜土路1298号', category: 'vet', access: 'indoor', features: 'dog bowl, dog treats', longitude: 121.463126, latitude: 31.197267 )
...
lewagon = Space.create(name: 'Le Wagon', address: '延平路425号2号楼401', category: 'other', access: 'indoor', features: 'dog bowl, dog treats', longitude: 121.43737, latitude: 31.233334 )
...
paw = Space.create(name: 'Paw Clinic', address: '东青莲路99号', category: 'vet', access: 'indoor', features: 'dog bowl, dog treats', longitude: 121.457754, latitude: 31.241917 )
...
dogcat = Space.create(name: 'Dog & Cat', address: '威海路379号', category: 'vet', access: 'indoor', features: 'dog bowl, dog treats', longitude: 121.46439, latitude: 31.227084 )
...
beckstone = Space.create(name: 'Doctors Beck & Stone', address: '威宁路500号', category: 'vet', access: 'indoor', features: 'dog bowl, dog treats', longitude: 121.386111, latitude: 31.217259 )
...
shenpu = Space.create(name: 'Shenpu Pet Hospital', address: '天山路185号', category: 'vet', access: 'indoor', features: 'dog bowl, dog treats', longitude: 121.382698, latitude: 31.215397 )
shenpu.image.attach(io: URI.open('https://www.thatsmags.com/image/view/201811/shenpu.jpg'), filename: 'shenpu')

pudi = Space.create(name: 'Pudi Boutique Hotel', address: '雁荡路99号', category: 'other', access: 'indoor', features: 'dog bowl, dog treats', longitude: 121.470061, latitude: 31.219298 )
...
fourpark = Space.create(name: 'Four Seasons Pet Park', address: '漕廊公路9133号', category: 'park', access: 'outdoor, indoor', features: '', longitude: 121.158609, latitude: 30.784756 )
...
zhujiajiao = Space.create(name: 'Zhujiajiao Water Village', address: '西湖街24号', category: 'park', access: 'outdoor, indoor', features: '', longitude: 121.053794, latitude: 31.107256 )
...
dongtan = Space.create(name: 'Dongtan Wetland Park', address: '东旺中路', category: 'park', access: 'outdoor', features: '', longitude: 121.910484, latitude: 31.513998 )
...
luneurs = Space.create(name: 'Luneurs', address: '番禺路381号', category: 'cafe', access: 'outdoor', features: '', longitude: 121.43049, latitude: 31.204387 )
